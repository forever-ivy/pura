  ...
  return (
    <div className="flex flex-col items-center justify-center h-[400px] space-y-8">
      <div className="relative w-48 h-48">
        <motion.div
          className="absolute inset-0 rounded-full bg-gradient-to-b from-green-400/25 via-emerald-500/10 to-transparent blur-2xl"
          animate={{ scale: [0.9, 1.06, 0.96], opacity: [0.6, 1, 0.7] }}
        ...
        />
        <motion.div
          className="absolute inset-6 rounded-full border border-green-500/15"
          animate={{ rotate: -360, opacity: [0.15, 0.4, 0.15] }}
          transition={{ duration: 18, repeat: Infinity, ease: "linear" }}
        />
        <motion.span
          className="absolute left-6 top-10 h-2 w-2 rounded-full bg-green-300/70 blur-[1px]"
          animate={{ y: [0, -12, 0], opacity: [0.2, 0.8, 0.2] }}
          transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.span
          className="absolute right-8 top-16 h-1.5 w-1.5 rounded-full bg-emerald-200/80 blur-[1px]"
          animate={{ y: [0, -10, 0], opacity: [0.2, 0.7, 0.2] }}
          transition={{ duration: 6.5, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.span
          className="absolute left-14 bottom-12 h-2.5 w-2.5 rounded-full bg-green-200/60 blur-[1px]"
        ...
        >
          <div className="absolute inset-0 flex items-center justify-center">
            <TreePine className="w-24 h-24 text-green-600 drop-shadow-[0_10px_20px_rgba(22,101,52,0.35)]" />
          </div>
        </motion.div>
      </div>
